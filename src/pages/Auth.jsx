    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.tabs}>
          <button style={{ ...styles.tab, ...(isLogin ? styles.tabActive : {}) }} onClick={() => { setIsLogin(true); setError(null) }}>Login</button>
          <button style={{ ...styles.tab, ...(!isLogin ? styles.tabActive : {}) }} onClick={() => { setIsLogin(false); setError(null) }}>Register</button>
        </div>
...
const styles = {
  ...
  tab: { flex: 1, padding: '.6rem', borderRadius: '6px', border: 'none', background: 'transparent', color: '#5A7A5E', fontWeight: '800', fontSize: '.82rem', cursor: 'pointer', letterSpacing: '1px', transition: 'all .2s' },
  ...
  payBox: { background: 'rgba(0,230,118,.05)', border: '1px solid rgba(0,230,118,.15)', borderRadius: '10px', padding: '1rem', textAlign: 'center' },
  payTitle: { fontSize: '.7rem', fontWeight: '800', letterSpacing: '1px', textTransform: 'uppercase', color: '#5A7A5E', marginBottom: '.5rem' },
  payText: { fontSize: '.88rem', color: '#5A7A5E', lineHeight: 1.8 },
  uploadWrap: { width: '100%' },
  uploadLabel: { display: 'block', padding: '.8rem', borderRadius: '8px', border: '1px dashed #1E2E20', color: '#5A7A5E', fontSize: '.82rem', fontWeight: '700', textAlign: 'center', cursor: 'pointer', transition: 'all .2s' },
